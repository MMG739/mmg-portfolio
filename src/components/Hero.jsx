  ...
  return (
    <section className="bg-white text-center py-20 mt-6 px-4 ">
      ...
      <h1 className="text-sm text-gray-500">
        FullStack Développeur | Data Scientist | Odoo Développeur | IA Développeur  | Ingénieur Logiciel
      </h1>
      ...
      <p className="mt-5 text-gray-600 max-w-xl mx-auto">
        ...
        finance — en proposant une tech utile, éthique et accessible.
      </p>
      <div className="mt-6 flex justify-center gap-8">
        <a href="#projects" className="bg-[var(--color-orange)] btn-effect-11 text-white px-6 py-2 rounded-md font-medium">
          Voir mes projets
        </a>
        <a href="#contact" className="border-2 btn-effect-11 border-[var(--color-orange)] text-[var(--color-orange)] px-6 py-2 rounded-md font-medium ">
          Me contacter
        </a>
      </div>
    </section>
