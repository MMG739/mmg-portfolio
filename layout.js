...
export const metadata = {
  ...
  description: "Portfolio de Mouhamadou Moustapha Gueye - Tech, Afrique, IA. D├®veloppeur FullStack, Odoo, IA & Data.",
  keywords: [
  ...
  openGraph: {
    title: "MMG Portfolio",
    description: "Portfolio de Mouhamadou Moustapha Gueye ÔÇö D├®veloppeur FullStack, Odoo, IA & Data.",
...
gtag('config', '${GA_ID}');`}
      ...
      <body
        className={`${spaceGrotesk.variable} ${jetbrainsMono.variable} font-sans bg-white dark:bg-[#0a0812] text-gray-900 dark:text-white antialiased`}
      >
        <noscript>
          <iframe
