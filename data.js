export const translations = {
  fr: {
    ...
    hero: {
      ...
      titleAccent: "de l'Afrique",
      titleEnd: "avec l'IA",
      description: "Senior Fullstack Developer & AI Engineer. Je d├®veloppe des solutions IA innovantes et des architectures logicielles scalables pour r├®pondre aux d├®fis ├®conomiques africains.",
      cta: "Mes Projets",
      stack: "Expert Odoo | React | Python | Data Science"
    },
    about: {
      title: "Architecte IA",
      subtitle: "M├®decine ÔåÆ G├®nie IA",
      description: "Ancien ├®tudiant en m├®decine devenu ing├®nieur, je fusionne la rigueur scientifique avec l'innovation technologique pour b├ótir l'avenir num├®rique du continent.",
      downloadCv: "CV",
      contact: "Contact",
      stats: {
      ...
      journey: {
        title: "Mon Parcours",
        medical: {
          title: "Fondation M├®dicale",
          desc: "Trois ann├®es intenses d'├®tudes m├®dicales m'ont l├®gu├® une rigueur d'analyse ph├®nom├®nale et une approche centr├®e sur l'humain."
        },
        software: {
          title: "Architecture Logicielle",
          desc: "Transition vers le code pour b├ótir des syst├¿mes robustes et scalables, capables de r├®soudre des probl├¿mes complexes ├á grande ├®chelle."
        }
      },
      impact: {
        badge: "Mission Active",
        title: "Impact Afrique",
        desc: "D├®ploiement de solutions IA localis├®es pour transformer la logistique de sant├® et l'├®ducation sur tout le continent."
      },
      techHeader: "Ecosyst├¿me Technique"
    },
    stats: {
      title: "Syst├¿me Metrics",
      subtitle: "Performances Globales",
      seniority: "S├®niorit├®",
      ecosystem: "├ëcosyst├¿me",
      impact: "Impact",
      arsenal: "Arsenal",
      years: "ANS",
      projets: "PROJETS",
    ...
    skills: {
      ...
      subtitle: "Stack & Ing├®nierie",
      ai: "Intelligence Artificielle G├®n├®rative",
      aiDesc: "Optimisation de LLM & Architectures Neuronales",
      frontend: "Frontend Core",
      devops: "DevOps & Cloud",
      impact: "Impact Hub",
      odoo: "Sp├®cialiste Odoo",
      deploy: "Ing├®nierie de D├®ploiement",
      active: "Activit├® R├®cente"
    },
    projects: {
      title: "Portfolio",
      subtitle: "Projets S├®lectionn├®s",
    ...
    footer: {
      ...
      madeWith: "R├®alis├® avec Passion & IA"
    }
  },
  en: {
    nav: {
    ...
    hero: {
      ...
      titleAccent: "of Africa",
      titleEnd: "with AI",
      description: "Senior Fullstack Developer & AI Engineer. I develop innovative AI solutions and scalable software architectures to address African economic challenges.",
      cta: "My Projects",
      stack: "Odoo Expert | React | Python | Data Science"
    },
    about: {
      title: "AI Architect",
      subtitle: "Medicine ÔåÆ AI Engineering",
      description: "Former medical student turned engineer, I merge scientific rigor with technological innovation to build the continent's digital future.",
      downloadCv: "CV",
      contact: "Contact",
      stats: {
      ...
      journey: {
        ...
        medical: {
          ...
          desc: "Three intense years of medical studies gave me phenomenal analytical rigor and a human-centered approach."
        },
        software: {
          title: "Software Architecture",
          desc: "Transition to code to build robust and scalable systems capable of solving complex problems at scale."
        }
      },
      impact: {
        badge: "Active Mission",
        title: "Africa Impact",
        desc: "Deploying localized AI solutions to transform healthcare logistics and education across the continent."
      },
      techHeader: "Technical Ecosystem"
    },
    stats: {
      title: "Metrics System",
      subtitle: "Global Performances",
      seniority: "Seniority",
      ecosystem: "Ecosystem",
      impact: "Impact",
      arsenal: "Arsenal",
    ...
    skills: {
      ...
      subtitle: "Stack & Engineering",
      ai: "Generative Artificial Intelligence",
      aiDesc: "LLM Optimization & Neural Architectures",
      frontend: "Frontend Core",
      devops: "DevOps & Cloud",
      impact: "Impact Hub",
      odoo: "Odoo Specialist",
      deploy: "Deployment Engineering",
    ...
    education: {
      title: "Education",
      subtitle: "Pathway & Certifications",
      diplomas: "Diplomas",
      certifications: "Certifications"
    },
    contact: {
...
export const projectsData = [
  ...
  },
  {
    ...
    highlights: {
      fr: ["Dashboard temps r├®el", "API REST", "S├®curit├® avanc├®e"],
  ...
  },
  {
    ...
    highlights: {
      fr: ["POS int├®gr├®", "Temps r├®el", "Multi-device"],
...
export const diplomesData = [
  {
    ...
    projects: {
      fr: ["Projet de fin d'├®tudes sur l'IA", "Application mobile collaborative"],
      en: ["AI Thesis project", "Collaborative mobile app"]
    }
  },
  {
    id: 2,
    ...
    projects: {
      fr: ["Syst├¿me de gestion de biblioth├¿que", "Site web e-commerce"],
      en: ["Library management system", "E-commerce website"]
    }
  }
];
...
export const certificationsData = [
  {
    ...
    verifyUrl: "#",
    skills: ["Cloud Computing", "Architecture", "S├®curit├®"],
    validUntil: "2026"
  },
  {
    id: 2,
